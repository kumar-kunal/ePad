...
chooser.addChoosableFileFilter(new MyFileFilter(".cpp","C++ Source Files(*.cpp)"));
...
String applicationName="TextPad";
...
Notepad()
{
ImageIcon iconFrame = new ImageIcon(getClass().getResource("res/icon.png"));


f=new JFrame(fileName+" - "+applicationName);
f.setIconImage(iconFrame.getImage());
...
{
JOptionPane.showMessageDialog(Notepad.this.f,aboutText,"Help",JOptionPane.INFORMATION_MESSAGE);
}
else
...
final String helpAboutNotepad="About ePad";

final String aboutText=
	"<html><big>Personal use only</big><br> By kunal</html>";
}